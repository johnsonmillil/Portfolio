  ...
  async mounted() {
    ...
    try {
      ...
      */
      ...
      const data = await getEventDetailsData(this.$route.params.id);
      const eventResponse = data.eventData;
      const clientsResponse = data.clientsData;
      const servicesResponse = data.servicesData;
