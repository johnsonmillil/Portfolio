...
// API call to GET all the client by ID
export const getClientDetailsData = async (id) => {
  const clientData = {};

  try {
    const response = await apiClient.get(`/clients/client/${id}`);

    clientData.clientData = response.data.clientData;
    clientData.clientEvents = response.data.clientEvents;
    clientData.nonClientEvents = response.data.nonClientEvents;
  } catch (error) {
    throw error;
  }
...
// API call to GET all dtails of an event by event ID
export const getEventDetailsData = async (id) => {
  ...
  try {
    ...
    eventData.eventData = response.data.event;
    eventData.clientsData = response.data.clients;
    eventData.servicesData = response.data.services;
  } catch (error) {
    throw error;
  }
  return eventData;
